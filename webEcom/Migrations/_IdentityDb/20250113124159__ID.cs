...
namespace webEcom.Migrations._IdentityDb
{
    /// <inheritdoc />
    public partial class _ID : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserConfirmPassword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    UserProfile = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistorViewModel", x => x.IdUser);
                });
